...
class CalcNode {
  ...
  protected:
    ...
    double relX, relY, relZ;    /**< Координаты относительно точки подвеса */

    double smth;                /**< Скалярное поле (например, температура/плотность) */
    double vx, vy, vz;          /**< Текущие скорости узла */
    double pressure;            /**< Давление потока в узле */
    double fx, fy, fz;          /**< Аэродинамическая сила, отнесённая к узлу */
    double alphaEff;            /**< эффективный угол атаки, рад */
    double alphaLag;            /**< запаздывающий аэродинамический угол */
    double lift;                /**< локальная подъемная сила узла */
